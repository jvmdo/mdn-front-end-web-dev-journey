...
openRequest.addEventListener("success", () => {
  ...
  // Display the notes already in the IDB
  displayData();
});
...
form.addEventListener("submit", function addData(e) {
  e.preventDefault();
...
function displayData() {
  // Empty the contents of the list in order to avoid duplicated items
  ...
  objectStore.openCursor().addEventListener("success", (e) => {
    ...
    if (cursor) {
      ...
      // so we know which item it corresponds to.
